...
export const mixin = {
    ...
    filters: {
        // 用于格式化时间的过滤器
        socialDate: function (formattedDate = '2000-03-27') {
            ...
            switch (lineBreakMode) {
                ...
                case LineBreakMode.EllipsisTruncatingMiddle:
                    if (text.length > maxLength) {
                        return text.substr(0, maxLength).substr(0, parseInt(maxLength / 2)) + '...' + text.substr(0, maxLength).substr(parseInt(maxLength / 2));
                    }
                    return text.substr(0, maxLength);
